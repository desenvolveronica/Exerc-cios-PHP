<nav class="modulos">
    ...
    <div class="modulo azul-escuro">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=classes_objetos&file=static copy">
                    Membros Estáticos NEW
                </a>
            </li>
            <li>
    ...
    <div class="modulo verde-escuro">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=repeticoes&file=desafio_impressoes">
                    Desafio Impressões
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="exercicio.php?dir=repeticoes&file=desafio_tebela">
                    Desafio Tabela #1
                </a>
            </li>
            <li>
                <a href="exercicio.php?dir=repeticoes&file=desafio_tebela2">
                    Desafio Tabela #2
                </a>
            </li>
        </ul>
    ...
    <div class="modulo roxo-escuro">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=tratamento_erro_treino&file=try_catch">
                    Tratamento_erro
                </a>
            </li>
        </ul>
